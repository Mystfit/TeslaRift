...
createNode mesh -n "panelShape" -p "panel";
	...
	setAttr ".bck" 3;
createNode mesh -n "panelShape1Orig" -p "panel";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "bend1Handle";
	setAttr ".r" -type "double3" 90.000000000000398 90 90.000000000000398 ;
...
connectAttr "panelShape.iog.og[4]" "bend1Set.dsm" -na;
...
connectAttr "panelShape.iog.og[5]" "tweakSet1.dsm" -na;
connectAttr "tweak1.msg" "tweakSet1.ub[0]";
connectAttr "polyFlipUV1.out" "groupParts2.ig";
...
connectAttr "panelShape.iog.og[6]" "bend2Set.dsm" -na;
