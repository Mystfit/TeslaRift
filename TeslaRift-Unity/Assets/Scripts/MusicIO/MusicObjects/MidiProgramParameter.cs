...
namespace MusicIO
{
     ...
     */
    public class MidiProgramParameter : InstrumentParameter
    {
        protected string m_arg;
        public MidiProgramParameter(string methodName, InstrumentHandle paramOwner, string argument, float min, float max)
